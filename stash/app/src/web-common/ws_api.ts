...
export type NewGameResponse = CommonResponse;
...
export type SetGameStateResponse = CommonResponse;
...
export type GoResponse = CommonResponse;

//---

export type StopRequest = undefined;

export type StopResponse = CommonResponse;
