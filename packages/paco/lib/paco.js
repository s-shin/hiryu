...
exports.sepBy = (p, sep, opts = exports.DEFAULT_MANY_OPTIONS) => exports.desc(exports.transform(exports.seq(p, exports.many(exports.seq(sep, p), opts)), vs => [vs[0], ...vs[1].map(xs => xs[1])]), "sepBy");
